...
public class SwaggerConfig {
	...
	private List<SecurityReference> sf() {
		...
		//AuthorizationScope scope = new AuthorizationScope("global", "");
		 AuthorizationScope[] scopes = { 
			      ...
			      new AuthorizationScope("apis", "Access all API") };
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend",
				"This project is developed by ali haider", "1.0", "Terms of Service",
				new Contact("ali", "https://www.linkedin.com/in/ali-haider-804903159/", "alihaidersw34@gmail.com"),
